...
readObj = urllib.request.urlopen("https://api.dmm.com/affiliate/v3/ItemList?api_id=" + APPID + "&affiliate_id=" + AFFILIATEID + "%20&site=DMM.R18&service=digital&floor=videoa&hits=10&sort=date&keyword=" + KEYWORD + "&output=json")
...
# print(data['result']['items'][2]['title'])
