...
# ツイート投稿用のURL
urlTweet = "https://api.twitter.com/1.1/statuses/update_with_media.json"
...
# body = urllib.request.urlopen("https://api.dmm.com/affiliate/v3/ItemList?api_id=" + APPID + "&affiliate_id=" + AFFILIATEID + "%20&site=DMM.R18&service=digital&floor=videoa&hits=10&sort=date&keyword=" + KEYWORD + "&output=json")
...
#
readObj = urllib.request.urlopen(url + APPID + "&affiliate_id=" + AFFILIATEID + "%20&site=DMM.R18&service=digital&floor=videoa&hits=10&sort=date&keyword=" + paramStr)
